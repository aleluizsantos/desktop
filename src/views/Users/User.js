        ...
        <Row>
          <Col md="4">
            <Card className="card-user">
              <div className="image">
                <img alt="..." src={require("../../assets/img/signIn.png")} />
              </div>
              <CardBody>
                <div className="author">
                  ...
                  <p className="description">@picanha&cia·Picanharia</p>
                </div>
                <p className="description text-center">
                  Restaurante de Carnes mais Saboroso da Cidade.
                </p>
              </CardBody>
            </Card>
          </Col>
